...
async def init():
    ...
    if (
        ...
        LOGGER("Aaro_officialbot").warning(
    ...
    try:
        ...
        LOGGER("Aaro_officialbot").error(
            "[ERROR] - \n\nHey Baby, firstly open telegram and turn on voice chat in Logger Group."
        )
        sys.exit()
    except:
        pass
    await Kaal.decorators()
    LOGGER("Aaro_officialbot").info("Congratulations, Your SankiMusic Bot Now Deployed ...")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("Aaro_officialbot").info("Stopping Music Bot...")
