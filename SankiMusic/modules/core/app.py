...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("OP_ARNAV_SINGH")
                await self.one.join_chat("link_copied")
                await self.one.join_chat("KING_COBRA_NETWORK")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("OP_ARNAV_SINGH")
                await self.one.join_chat("link_copied")
                await self.one.join_chat("KING_COBRA_NETWORK")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("OP_ARNAV_SINGH")
                await self.one.join_chat("link_copied")
                await self.one.join_chat("KING_COBRA_NETWORK")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("OP_ARNAV_SINGH")
                await self.one.join_chat("link_copied")
                await self.one.join_chat("KING_COBRA_NETWORK")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("OP_ARNAV_SINGH")
                await self.one.join_chat("link_copied")
                await self.one.join_chat("KING_COBRA_NETWORK")
            except:
                pass
